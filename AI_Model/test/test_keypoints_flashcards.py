...
ADAPTER_DIR = PROJECT_ROOT / "models" / "keypoints_flashcards"
...
def generate_keypoints_and_flashcards(text: str, tokenizer, model, device):
    prompt = (
        "<|system|>\n"
...
if __name__ == "__main__":
    ...
    sample_text = """
    The ALU performs arithmetic operations like addition, subtraction, and multiplication.
    It also performs logical operations such as comparison.
    After processing, the result is transferred to the storage unit.
    """

    result = generate_keypoints_and_flashcards(sample_text, tokenizer, model, device)
